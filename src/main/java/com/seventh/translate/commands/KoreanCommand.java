...
@Component
public class KoreanCommand implements MessageCommand {
    @Autowired
    ...
    private InteractionFollowupCreateMono handleTranslation(MessageInteractionEvent event) throws URISyntaxException, IOException, InterruptedException {
        ...
        String langPair = detectedLanguage + "|ko";
        if (langPair.equals("ko|ko")) {
            isSameLang = true;
        }
        Optional<Instant> editedTimestamp = resolvedMessage.getEditedTimestamp();
        String cache_message_id = guild_identifier + "_" + channel_id + "_" + message_id + "_ko";
        ...
        return event
                ...
                .withEmbeds(
                        EmbedCreateSpec
                                ...
                                .title(EmbedTitleEnum.KO.langTitle)
